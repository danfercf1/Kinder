...
{
     // this.url = "img/fondo.png";   
 
       this.init = function()
       {        
          // bg= new Bitmap(fondo.url);        
          // stage.addChild(bg);
       }
...
var soy_padre = new function()
{
    
    this.obj = new Container();        
    this.url = "images/images_home/soy_padre.png";
            
    this.init = function()
    {  
        
       stage.addChild(soy_padre.obj) ;         
       soy_padre.init_fondo() ; 
       this.resize(); 
    ...
    this.init_fondo = function()
    {
        ...
        var soy_padre_imagen = new Bitmap(soy_padre.url);
       
        //Shape
        
        var s = new Shape(soy_padre_imagen);
    ...
    {        
        ...
        soy_padre.obj.x = (1920 - jQuery('body').Width)/2 + xbrowser;         
        soy_padre.obj.y = (1080 - jQuery('body').Height)/2 + ybrowser;
...
var flores_1 = new function()
{
    ...
    this.resize = function() 
    {   /*     
        flores_1.obj.x = (canvas_home.width/2)  -420;         
        flores_1.obj.y = (canvas_home.height/2)-220 ;
        */
...
var manguera_agua = new function()
{
 ...
 var manguera_gotas_1 = new function()
 {
    ...
    {  
       ...
       /* 
            manguera_gotas_1.obj.x = (canvas_home.width/2)-10  ;          
            manguera_gotas_1.obj.y = (canvas_home.height/2)+165 ;
       */
 ...
 var manguera_gotas_5 = new function()
 {
    ...
    {  
       /* 
           manguera_gotas_4.obj.x = (canvas_home.width/2)+8 ;          
           manguera_gotas_4.obj.y = (canvas_home.height/2)+270 ;
       */
...
{   
    ...
    this.resize = function() 
    {   /*        
        nube_12.obj.x =(canvas_home.width ) ;          
        nube_12.obj.y = 150 ;
        */ 
       // nube_12.obj.x =(canvas_home.width )-200 ;
...
{   
    ...
    this.resize = function() 
    {   /*        
               soy_padre.obj.x = (canvas_home.width/2)  -420;         
        soy_padre.obj.y = (canvas_home.height/2)-220 ;
        */ 
...
{   
    ...
    {  
        ...
        */
         ...
         // nube_14.obj.x = (canvas_home.width) + 350   ; 
...
{   
    ...
    {   
        /*
             ...
             pajaro_amarillo_1.obj.x =(canvas_home.width/2)+350  ;          
             pajaro_amarillo_1.obj.y =(canvas_home.height/2)-140 ; 
...
{   
    ...
    {   
         /*        
            pajaro_amarillo_2.obj.x =(canvas_home.width/2)+370  ;          
            pajaro_amarillo_2.obj.y =(canvas_home.height/2)-220 ; 
        */ 
...
{   
    ...
    {   
        /* 
        pajaro_amarillo_3.obj.x =(canvas_home.width/2)+420  ;          
        pajaro_amarillo_3.obj.y =(canvas_home.height/2)-120 ;
        */
...
{   
    ...
    {   
       /*  
        pajaro_amarillo_4.obj.x =(canvas_home.width/2)+240  ;          
        pajaro_amarillo_4.obj.y =(canvas_home.height/2)-180 ;
        */
...
{   
    ...
    {   
        /* 
            pajaro_amarillo_5.obj.x =(canvas_home.width/2)+450  ;          
            pajaro_amarillo_5.obj.y =(canvas_home.height/2)-150 ;
        */
