...
{   
   ...
   tiempo= 50800+Math.round(Math.random()*(50000));
     ...
     animacion_home.mover_nube_izq_der_horizontal( nube_9 , Xf , tiempo , tipoEfecto ) ;
     
       Xf=-200;
   //    tiempo=4;
   tiempo= 50900+Math.round(Math.random()*(50000));
       
     animacion_home.mover_nube_der_izq_horizontal( nube_10 , Xf , tiempo , tipoEfecto ) ;
     ...
     animacion_home.mover_nube_izq_der_horizontal( nube_11 , Xf , tiempo , tipoEfecto ) ;
     
       Xf=-200;
    //   tiempo=10 ;
     tiempo= 60100+Math.round(Math.random()*(50000));
       
     animacion_home.mover_nube_der_izq_horizontal( nube_12 , Xf , tiempo , tipoEfecto ) ;
     ...
     animacion_home.mover_nube_izq_der_horizontal( nube_13 , Xf , tiempo , tipoEfecto ) ;     
      Xf=-200 ;         
     //   tiempo = 9 ;      
        tiempo= 60300+Math.round(Math.random()*(50000));       
        animacion_home.mover_nube_der_izq_horizontal( nube_14 , Xf , tiempo , tipoEfecto ) ;     
   ...
   // *************** ANIMACION DE PAJAROS ROJOS **************************    
    ...
    /************* GUARDIA TIERRA *************** */       
        ...
        tiempo_espera = 500    ;
         ...
         Xf = soy_padre .obj.x-30   ;
         Yf = soy_padre .obj.y-15    ; 
                          
                          
         animacion_home . mover_soy_padre ( soy_padre , Xf , Yf , tiempo , tiempo_espera , tipoEfecto ) ;  
          ...
          /* animacion_home.escalado_en_XoY(cursor_derecha.obj,1.2,"X");
           animacion_home.escalado_en_XoY(cursor_izquierda.obj,1.2,"X");*/           
           
           //animacion_home.escalado_en_XoY(registrate.obj,0.81,"XY");
           
           animacion_home.puntero_objeto(registrate);
           
           animacion_home.objeto_fancy(registrate,'registro.php');
                      
           
           /*animacion_home.parpadeo(cursor_derecha,5,1); 
           
           animacion_home.parpadeo(cursor_izquierda,5,1);*/
