var animacion_museo = new function(){
   ...
   this.burbujas = function(count, x, y, x0,y0,yf,t,bub) {
    ...
    this.botones = function(obj){
        ...
        obj.onClick = function(evt){
           ...
           if(obj.name == "der"){
                  ...
                  if(animacion_museo.index+1 < ostra.json_consultasorpresa.length){
                  ...
                  if(ostra.json_consultasorpresa[animacion_museo.index]['IMAGEN_SORPRESA']!=""){
                        ...
                        ostra.add_sorpresas(ROOT_PATH+"frontend/resize_images/"+ostra.json_consultasorpresa[animacion_museo.index]['IMAGEN_SORPRESA']+"/196/172");
           ...
           if(obj.name == "izq"){
                    ...
                    if(animacion_museo.index > 0){
                        ...
                        animacion_museo.index = ostra.json_consultasorpresa.length-1;
                    }
    ...
    this.escalado = function(objeto,tam,inout){
        
        objeto.scale = 1; 
        
        switch(inout){
            case 0: objeto.scaleX = objeto.scaleY = objeto.scale;    //Normal
            break;
            case 1:  objeto.scaleX = objeto.scaleY = objeto.scale*tam; //Escalar 
            break;
        }
    ...
    this.puntero = function(objeto){
        ...
        objeto.onMouseOver = function(){
                ...
                animacion_museo.escalado(objeto,1.02,1);
                stage_museo.update();
        ...
        objeto.onMouseOut = function(){
                ...
                animacion_museo.escalado(objeto,0,0);
                stage_museo.update();
