function init_museo(){
    ...
    jQuery.getJSON('frontend/surprises/',function(data){
        
        ostra.json_consultasorpresa = data;
    ...
    **/
    ...
    animacion_museo.puntero(ostra.cursorleft);
    
    animacion_museo.puntero(ostra.cursorright);
    ...
    **/
    ...
    animacion_museo.burbujas(7,0,0,500,800,-100,10,4);
    
    animacion_museo.burbujas(10,0,0,1200,800,-100,15,4);
