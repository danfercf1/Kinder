...
var navegador = new function(){
    ...
    this.juegos = new Container();
    
    this.bitmap_juegos = new Array();
    
    this.url = "images/juegos/plattaform.png";

    this.textoJuegos = new Bitmap("images/juegos/textGames.png");

    this.cursorizq = new Bitmap("images/juegos/arrowLeft.png");
    
    this.cursorder = new Bitmap("images/juegos/arrowRight.png");
    
    this.juegos_temporal = new Array(
    new Array("images/juegos/juegos_temporal/games2.png","http://www.kindervelocidad.com/"),
    new Array("images/juegos/juegos_temporal/games1.png","http://skater.kinder.com.ar/")
    ...
    this.init = function(){
        ...
        navegador.bitmap_juegos[0] = new Bitmap("images/juegos/juegos_temporal/games2.png");
        navegador.bitmap_juegos[1] = new Bitmap("images/juegos/juegos_temporal/games1.png");
        
        navegador.bitmap_juegos[0].name = "velocidad";
        
        navegador.bitmap_juegos[1].name = "skater";
                
        stage_juegos.addChild(navegador.obj);

        navegador.init_textoJuegos();
    ...
    this.init_textoJuegos = function(){
        ...
        navegador.textoJuegos.x = 25;

        navegador.textoJuegos.y = -130;

        navegador.obj.addChild(navegador.textoJuegos);
    }
    ...
    this.add_juegos = function(img){
       
        this.juego = img;
        
        navegador.juegos.x = 98;
        
        navegador.juegos.y = -95;
        
        //navegador.juego.alpha = 0;
        
        //animacion_juegos.fadein(this.juego);
        
        //console.log(this.juego.id);
        
        navegador.juegos.addChildAt(this.juego,5);
        
        navegador.obj.addChild(navegador.juegos);
        
    }
    
    this.resize = function(){
        
        navegador.obj.x = (canvas_juegos.width/2) - 135;
        
        navegador.obj.y = (canvas_juegos.height/2) + 95;
    }
}
